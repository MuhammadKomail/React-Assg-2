...
function App() {
  ...
  return (
    ...
    <>
      <div className="dinline d-flex align-content-start flex-wrap">
        <div className="dinline d-flex align-content-start flex-wrap">
          {/* <Grid container spacing={2}> */}
            <Grid item xs={4}>
              {
                cardData.map((data, index) => {
                  return <Card key={index} style={{display:'inline'}} src={data.imgLink} title={data.title} price={new Intl.NumberFormat().format(data.price)} description={data.description} />
                })
              }
            </Grid>
          {/* </Grid> */}
